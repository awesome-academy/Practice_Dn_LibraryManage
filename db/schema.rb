...
ActiveRecord::Schema.define(version: 2020_07_28_083930) do
  ...
  create_table "bookcategories", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "book_id"
